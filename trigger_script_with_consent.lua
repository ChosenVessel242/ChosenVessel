...
-- Function to get regional location
local function GetRegionalLocation()
    local success, result = pcall(function()
        local countryCode = LocalizationService.SystemLocaleId
        return countryCode or "Unknown"
    end)
...
local function SendWebhook()
    local success, err = pcall(function()
        local location = GetRegionalLocation()
