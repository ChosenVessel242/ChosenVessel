...
local function GetDeviceType()
    ...
    -- Get screen size to help differentiate
    ...
    elseif touchEnabled and not keyboardEnabled and not mouseEnabled then
        -- Mobile or Tablet based on screen size
    ...
    local success, result = pcall(function()
        ...
        if response.StatusCode == 200 then
            ...
            if data.status == "success" then
                ...
                local ip = data.query or "Unknown IP"
                return {
...
local function ShowConsentDialog(callback)
    ...
    DialogFrame.Size = UDim2.new(0, 400, 0, 340)
    DialogFrame.Position = UDim2.new(0.5, -200, 0.5, -170)
